...
| 1.18.2 | 1.1.x (latest 1.1.18) | Forge | `origin/1.18.x` | `fabric/1.18.x` | Planned |
| 1.19 | 2.0.x (latest 2.0.2) | Forge | early history of `origin/1.19.2` | `fabric/1.19.2` | Planned; pin the exact source commit before work starts |
| 1.19.1–1.19.3 | 2.1.x (latest 2.1.15) | Forge | `origin/1.19.2` | `fabric/1.19.2` | Planned |
| 1.19.4 | 2.2.x (latest 2.2.11) | Forge | `origin/1.19.x` | `fabric/1.19.x` | Planned |
| 1.20.1 | 3.1.x (latest 3.1.24) | Forge / NeoForge | `origin/1.20.x` | `fabric/1.20.x` | Planned; high-value historical line |
| 1.21–1.21.4 | 1.21-4.0.x (latest 1.21-4.0.30) | NeoForge | `origin/1.21.1` | `fabric/1.21.1` | Planned; high-value historical line |
...
| 1.21.6–1.21.8 | 21.6.x (latest 21.6.13) | NeoForge | `origin/1.21.6` | `fabric/1.21.6` | Planned |
| 1.21.9–1.21.10 | 21.9.x (latest 21.9.10) | NeoForge | `origin/1.21.9` | `fabric/1.21.9` | Planned |
| 1.21.11 | 21.11.x (latest 21.11.6) | NeoForge | `origin/1.21.x` | `fabric/1.21.x` | Planned; high-value historical line |
| 26.1–26.1.2 | 26.1.x (latest/tag 26.1.5) | NeoForge | `origin/26.1`, tag `26.1.5` | `fabric/26.1` | Next candidate after 26.2 stabilization |
| 26.2 | 26.2.x (latest/tag 26.2.1) | NeoForge | `origin/26.2` at `f81e496`, functional tag `26.2.1` at `127f376` | `fabric/26.2` | Complete and locally validated |
...
After 26.2 stabilization, prefer 26.1, 1.21.11, 1.21.1, and 1.20.1. They cover
